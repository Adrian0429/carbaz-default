...
<main>
    ...
    <section class="banner" style="background-image: url({{ asset($homepage->home3_intro_image) }});">
        <div class="container">
                                            ...
                                            <div class="banner-slick-thumb-overlay-icon-main-item">
                                                <span class="banner-slick-thumb-overlay-icon" >
                                                    <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        ...
                                                        <path d="M10.5416 2.52393H3.79162C3.58434 2.52393 3.41661 2.66978 3.41661 2.85003V6.76925C3.41661 6.9495 3.58434 7.09535 3.79162 7.09535H10.5416C10.7489 7.09535 10.9166 6.9495 10.9166 6.76925V2.85C10.9166 2.66978 10.7489 2.52393 10.5416 2.52393ZM10.1666 6.44314H4.16659V3.17611H10.1666V6.44314Z" fill="#46D993" stroke="#46D993" stroke-width="0.2"/>
                                                        </svg>
                ...
                @if ($home3_ads->status == 'enable')
                    <div class="col-lg-3">
                        <div class="feature-thumb">
                            <a href="{{ $home3_ads->link }}" target="_blank"> <img src="{{ asset($home3_ads->image) }}" alt="img"></a>
                        </div>
                    </div>
                @endif
            </div>
