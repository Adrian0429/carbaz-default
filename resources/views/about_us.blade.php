                        ...
                        <div class="taitel-img">
                            <span>
                                <svg width="193" height="6" viewBox="0 0 193 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M1 5C27.1079 1.98151 101.859 -2.24439 192 5" stroke="#405FF2" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                        ...
                        <div class="taitel-img">
                            <span>
                                <svg width="71" height="8" viewBox="0 0 71 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M1 6.08589C15.5 0.18137 51.5 -0.151783 70 6.42496" stroke="#405FF2" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                    </svg>
                        ...
                        <div class="taitel-img">
                            <span>
                                <svg width="150" height="6" viewBox="0 0 150 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M1 5C21.2302 1.98151 79.1525 -2.24439 149 5" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                    </svg>
    ...
    <section class="help help-inner  ">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="help-img">
                        <img src="{{ asset($homepage->callus_image) }}" alt="img">
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="taitel-img">
                                    <span>
                                        <svg width="154" height="6" viewBox="0 0 154 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M1 5C21.777 1.98151 81.2647 -2.24439 153 5" stroke="#405FF2" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                        </svg>
