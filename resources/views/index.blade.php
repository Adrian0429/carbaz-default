                                ...
                                <div class="banner-sarchber-box">
                                    <form class="banner-sarchber-box-item" action="{{ route('listings') }}">
                                        ...
                                        <div class="banner-sarchber-box-inner">
                                            ...
                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M5.82426 0.575638C5.58995 0.341324 5.21005 0.341324 4.97574 0.575638L0.975736 4.57564C0.741421 4.80995 0.741421 5.18985 0.975736 5.42417C1.21005 5.65848 1.58995 5.65848 1.82426 5.42417L4.8 2.44843L4.8 12.9999C4.8 13.3313 5.06863 13.5999 5.4 13.5999C5.73137 13.5999 6 13.3313 6 12.9999L6 2.44843L8.97574 5.42417C9.21005 5.65848 9.58995 5.65848 9.82426 5.42417C10.0586 5.18985 10.0586 4.80995 9.82426 4.57564L5.82426 0.575638Z" />
                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M12.6 13.6001C12.7591 13.6001 12.9117 13.5369 13.0243 13.4244L17.0243 9.42436C17.2586 9.19005 17.2586 8.81015 17.0243 8.57583C16.7899 8.34152 16.41 8.34152 16.1757 8.57583L13.2 11.5516V1.0001C13.2 0.668726 12.9314 0.400097 12.6 0.400097C12.2686 0.400097 12 0.668726 12 1.0001V11.5516L9.02426 8.57583C8.78995 8.34152 8.41005 8.34152 8.17574 8.57583C7.94142 8.81015 7.94142 9.19005 8.17574 9.42436L12.1757 13.4244C12.2883 13.5369 12.4409 13.6001 12.6 13.6001Z" />
                                            </svg>
                                            </span>
                                            <select class="form-select form-select-lg"
        ...
        <div class="container">
            <div class="row align-items-end">
                <div class="col-lg-6 col-sm-6  col-md-6">
                    <div class="taitel two">
                        <div class="taitel-img">
                            <span><svg width="188" height="6" viewBox="0 0 188 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="taitel-img">
                            <span>
                                <svg width="161" height="6" viewBox="0 0 161 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M1 5C22.7338 1.98151 84.9612 -2.24439 160 5" stroke="#405FF2" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                    </svg>
                ...
                <div class=" col-xl-6 col-lg-8">
                    <div class="feature-two-img-main">
                        <div class="feature-two-img">
                            <a href="{{ $home1_ads->link }}"><img src="{{ asset($home1_ads->image) }}" alt="thumb"></a>
                        </div>
                    </div>
                </div>
                @endif
                ...
                <div class="col-lg-7 loan-bg" data-aos="fade-down" data-aos-duration="1000">
                    <div class="row ">
                        <div class="col-lg-7 col-sm-6">
                            <h2 class="loan-taitel">{{ __('translate.Auto Loan') }} <span>{{ __('translate.Calculator') }}</span></h2>
                            <form>
                                ...
                                <div class="loan-form-min">
                                    ...
                                    <div class="loan-form-item-btn">
                                        <button type="button" id="calculate_btn" class="thm-btn-two">{{ __('translate.Loan Calculate') }}</button>
                        ...
                        <div class="col-lg-5 col-sm-6">
                            <div class="estimate-item">
                                ...
                                <div class="estimate-payment">
                                    <ul>
                                        <li>{{ __('translate.Monthly Payment') }}: <span id="monthly_payment">{{ currency(0.00) }}</span></li>
                                        <li>{{ __('translate.Total Interest') }}:<span id="total_interest">{{ currency(0.00) }}</span></li>
                                        <li>{{ __('translate.Total Payment') }}: <span id="total_payment">{{ currency(0.00) }}</span></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="taitel-img">
                            <span>
                                <svg width="128" height="6" viewBox="0 0 128 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M1 5C18.223 1.98151 67.5353 -2.24439 127 5" stroke="#405FF2" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                    </svg>
